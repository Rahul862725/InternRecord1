...
def findYT(search):
    ...
    link = "http://www.youtube.com/results?search_query=" + '+'.join(words)
...
class HandRecog:
    ...
    def get_gesture(self):
        ...
        elif Gest.FIRST3 == self.finger :
            #[[8,5,0],[12,9,0],[16,13,0],[20,17,0]]
            point = [[8,12],[5,9],[12,16]]
            dist1 = self.get_dist(point[0])
            dist2 = self.get_dist(point[1])
